...
library.json = {
    ...
    $(".api-status").length > 0 && $.getJSON("").done(
        ...
        var e = 'http://api.govwizely.com/v2/trade_events/search?api_key=-DgaM8IefU4280JDV36SHZC1'+ $(this).parents(".api-explorer-form").find(
                 ".api-explorer-query-trade-events" ).val(),
    ...
    }), $(".api-explorer-query-trade-events").keypress(function(e) {
