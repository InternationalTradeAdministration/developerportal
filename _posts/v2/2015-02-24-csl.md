...
Searches against fields in the **addresses** array.
    ...
    http://api.trade.gov/consolidated_screening_list/search?address={query}

**_Example_**

[http://api.trade.gov/consolidated_screening_list/search?address=montreal](http://api.trade.gov/consolidated_screening_list/search?address=montreal)
...
Searches against the **name** and **alt_names** fields.  
    ...
    http://api.trade.gov/consolidated_screening_list/search?name={query}

**_Example_**

[http://api.trade.gov/consolidated_screening_list/search?name=caribe sol](http://api.trade.gov/consolidated_screening_list/search?name=caribe sol)
...
Enter a value (0-2) to utilize fuzzy matching when searching for **name** or **address**.  The value corresponds to the [Levenshtein distance](http://en.wikipedia.org/wiki/Levenshtein_distance).   
    ...
    http://api.trade.gov/consolidated_screening_list/search?fuzziness={fuzziness value}

**_Example_**

[http://api.trade.gov/consolidated_screening_list/search?name=caribe sol&fuzziness=2](http://api.trade.gov/consolidated_screening_list/search?name=caribe sol&fuzziness=2)
...
Searches based on the type of the entry (e.g, Individual, Entity, Vessel).
	...
	http://api.trade.gov/consolidated_screening_list/search?type={entry type}

**_Example_**

[http://api.trade.gov/consolidated_screening_list/search?type=Individual](http://api.trade.gov/consolidated_screening_list/search?type=Individual)


###start_date

Returns entries based on their start date.  Dates are filtered by comparing them against an inclusive range, which must be entered with the following format:  YYYY-mm-dd TO YYYY-mm-dd.

    http://api.trade.gov/consolidated_screening_list/search?start_date={YYYY-mm-dd TO YYYY-mm-dd}

**_Example_**

[http://api.trade.gov/consolidated_screening_list/search?start_date=2001-01-01 
TO 2015-12-31](http://api.trade.gov/consolidated_screening_list/search?start_date=2001-01-01 TO 2015-12-31)


###end_date

Returns entries based on their end date.  Dates are filtered by comparing them against an inclusive range, which must be entered with the following format:  YYYY-mm-dd TO YYYY-mm-dd.

    http://api.trade.gov/consolidated_screening_list/search?end_date={YYYY-mm-dd TO YYYY-mm-dd}

**_Example_**

[http://api.trade.gov/consolidated_screening_list/search?end_date=2001-01-01 
TO 2015-12-31](http://api.trade.gov/consolidated_screening_list/search?end_date=2001-01-01 TO 2015-12-31)


###issue_date

Returns entries based on the issue dates of the ids array.  Dates are filtered by comparing them against an inclusive range, which must be entered with the following format:  YYYY-mm-dd TO YYYY-mm-dd.

    http://api.trade.gov/consolidated_screening_list/search?issue_date={YYYY-mm-dd TO YYYY-mm-dd}

**_Example_**

[http://api.trade.gov/consolidated_screening_list/search?issue_date=2001-01-01 
TO 2015-12-31](http://api.trade.gov/consolidated_screening_list/search?issue_date=2001-01-01 TO 2015-12-31)


###expiration_date

Returns entries based on the expiration dates of the ids array.  Dates are filtered by comparing them against an inclusive range, which must be entered with the following format:  YYYY-mm-dd TO YYYY-mm-dd.

    http://api.trade.gov/consolidated_screening_list/search?expiration_date={YYYY-mm-dd TO YYYY-mm-dd}

**_Example_**

[http://api.trade.gov/consolidated_screening_list/search?expiration_date=2001-01-01 
TO 2015-12-31](http://api.trade.gov/consolidated_screening_list/search?expiration_date=2001-01-01 TO 2015-12-31)
...
[http://api.trade.gov/consolidated_screening_list/search?country=JO&size=1&offset=1](http://api.trade.gov/consolidated_screening_list/search?country=JO&size=1&offset=1)
...
[http://api.trade.gov/consolidated_screening_list/search?sources=561](http://api.trade.gov/consolidated_screening_list/search?sources=561)
...
[http://api.trade.gov/consolidated_screening_list/search?sources=ISA](http://api.trade.gov/consolidated_screening_list/search?sources=ISA)
...
---
_This endpoint and its documentation has been updated to Version 2. Please visit the [API v1 Documentation]({{ site.baseurl }}/v1/consolidated-screening-list.html) page for the Version 1 documentation._
