...
**Note**: The *fuzzy_name* parameter only works in tandem with *name*. Set *fuzzy_name=true* to utilize fuzzy name matching when searching against the **name** and **alt_names** fields.  The default setting for *fuzzy_name* is *false*.
