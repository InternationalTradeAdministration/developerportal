...
[API v1 Documentation]({{ site.baseurl }}/v1/consolidated-screening-list.html)
...
Searches for a match within the **name**, **alt_names**, **remarks**, and **title** fields from all nine lists.
...
These two lists from the State Department, the *ITAR Debarred List* and the *Nonproliferation Sanctions List*, do not have a **Country** field.  As such, any query where the **Country** is specified will not search these two lists.
