...
[http://api.trade.gov/v2/consolidated_screening_list/search](http://api.trade.gov/v2/consolidated_screening_list/search)

	{
	addresses: [ ],
	alt_names: [
	"ABDELRAZIK, Sofian",
	"ABDELRAZIK, Abousofiane",
	"ABDELRAZIK, Abousfian Salman",
	"ABD AL RAZEQ, Abu Sufian",
	"ABOU EL LAYTH",
	"ABOULAIL",
	"ABULAIL",
	"JOLAIBA",
	"DJOLAIBA THE SUDANESE",
	"OULD EL SAYEIGH",
	"ABDELRAZEK, Abousofian",
	"ABU SUFIAN",
	"ABU JUIRIAH",
	"ABDELRAZIK, Abousofian"
	],
	citizenships: [ ],
	dates_of_birth: [
	"1962-08-06"
	...
	name: "'ABD AL-RAZZIQ, Abu Sufian al-Salamabi Muhammed Ahmed",
	nationalities: [
	"SD",
	"CA"
	],
	...
	source_information_url: "http://www.treasury.gov/resource-center/sanctions/SDN-List/Pages/default.aspx",
	source_list_url: "http://www.treasury.gov/ofac/downloads/sdn.xml",
	title: null,
	type: "Individual"
	},
...
Searches for a match within the **name**, **alt_names**, **remarks**, and **title** fields from all eleven lists.
    ...
    http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&q={term}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?q=chemical](http://api.trade.gov/v2/consolidated_screening_list/search?q=chemical)

###sources

Searches only the lists specified by the **Source** Abbreviation.

    http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&sources={csl_type}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?sources=ISN,SDN](http://api.trade.gov/v2/consolidated_screening_list/search?sources=ISN,SDN)
...
Searches only parties whose **country** field matches the country code based on ISO [alpha-2 country codes](http://www.iso.org/iso/home/standards/country_codes/country_names_and_code_elements.htm).  Note:  This method allows you to search for multiple countries (plural) but will only return one country (singular) per party.  
    ...
    http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&countries={country code}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?countries=JO,PS](http://api.trade.gov/v2/consolidated_screening_list/search?countries=JO,PS)
...
Searches against fields in the **addresses** array.
    ...
    http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&address={query}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?address=montreal](http://api.trade.gov/v2/consolidated_screening_list/search?address=montreal)
...
Searches against the **name** and **alt_names** fields.  
    ...
    http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&name={query}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?name=caribe sol](http://api.trade.gov/v2/consolidated_screening_list/search?name=caribe sol)
...
Enter a value (0-2) to utilize fuzzy matching when searching for **name** or **address**.  The value corresponds to the [Levenshtein distance](http://en.wikipedia.org/wiki/Levenshtein_distance).   
    ...
    http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&fuzziness={fuzziness value}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?name=caribe sol&fuzziness=2](http://api.trade.gov/v2/consolidated_screening_list/search?name=caribe sol&fuzziness=2)
...
Searches based on the type of the entry (e.g, Individual, Entity, Vessel).
	...
	http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&type={entry type}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?type=Individual](http://api.trade.gov/v2/consolidated_screening_list/search?type=Individual)
...
Returns entries based on their start date.  Dates are filtered by comparing them against an inclusive range, which must be entered with the following format:  YYYY-mm-dd TO YYYY-mm-dd.  Searching on a single date can be done by entering the same value for the start and end of the range.
    ...
    http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&start_date={YYYY-mm-dd TO YYYY-mm-dd}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?start_date=2001-01-01 
TO 2015-12-31](http://api.trade.gov/v2/consolidated_screening_list/search?start_date=2001-01-01 TO 2015-12-31)
...
Returns entries based on their end date.  Dates are filtered by comparing them against an inclusive range, which must be entered with the following format:  YYYY-mm-dd TO YYYY-mm-dd.  Searching on a single date can be done by entering the same value for the start and end of the range.
    ...
    http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&end_date={YYYY-mm-dd TO YYYY-mm-dd}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?end_date=2001-01-01 
TO 2015-12-31](http://api.trade.gov/v2/consolidated_screening_list/search?end_date=2001-01-01 TO 2015-12-31)
...
Returns entries based on the issue dates of the ids array.  Dates are filtered by comparing them against an inclusive range, which must be entered with the following format:  YYYY-mm-dd TO YYYY-mm-dd.  Searching on a single date can be done by entering the same value for the start and end of the range.
    ...
    http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&issue_date={YYYY-mm-dd TO YYYY-mm-dd}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?issue_date=2001-01-01 
TO 2015-12-31](http://api.trade.gov/v2/consolidated_screening_list/search?issue_date=2001-01-01 TO 2015-12-31)
...
Returns entries based on the expiration dates of the ids array.  Dates are filtered by comparing them against an inclusive range, which must be entered with the following format:  YYYY-mm-dd TO YYYY-mm-dd.  Searching on a single date can be done by entering the same value for the start and end of the range.
    ...
    http://api.trade.gov/v2/consolidated_screening_list/search?api_key={your key}&expiration_date={YYYY-mm-dd TO YYYY-mm-dd}

**_Example_**

[http://api.trade.gov/v2/consolidated_screening_list/search?expiration_date=2001-01-01 
TO 2015-12-31](http://api.trade.gov/v2/consolidated_screening_list/search?expiration_date=2001-01-01 TO 2015-12-31)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?country=JO&size=1&offset=1](http://api.trade.gov/v2/consolidated_screening_list/search?country=JO&size=1&offset=1)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=DPL](http://api.trade.gov/v2/consolidated_screening_list/search?sources=DPL)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=EL](http://api.trade.gov/v2/consolidated_screening_list/search?sources=EL)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=UVL](http://api.trade.gov/v2/consolidated_screening_list/search?sources=UVL)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=ISN](http://api.trade.gov/v2/consolidated_screening_list/search?sources=ISN)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=DTC](http://api.trade.gov/v2/consolidated_screening_list/search?sources=DTC)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=FSE](http://api.trade.gov/v2/consolidated_screening_list/search?sources=FSE)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=PLC](http://api.trade.gov/v2/consolidated_screening_list/search?sources=PLC)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=SSI](http://api.trade.gov/v2/consolidated_screening_list/search?sources=SSI)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=SDN](http://api.trade.gov/v2/consolidated_screening_list/search?sources=SDN)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=561](http://api.trade.gov/v2/consolidated_screening_list/search?sources=561)
...
[http://api.trade.gov/v2/consolidated_screening_list/search?sources=ISA](http://api.trade.gov/v2/consolidated_screening_list/search?sources=ISA)
