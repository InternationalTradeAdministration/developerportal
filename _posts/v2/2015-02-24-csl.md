...
##Last Updated and Last Imported Fields

Each list is imported into the API every night unless the data in the list has not been changed.  If a list has changed since the previous night, then the list is imported and its *last_imported* field is updated.  Its *source_last_updated* is also updated to reflect the date and time that the agency updated the list.

If a list has not changed, then it is not imported.  The *source_last_updated* and the *last_imported* fields are not updated.

###sources_used

| Field	| Description |
| ------| -------------|
| source | The name of the list and the source agency that publishes it |
| source_last_updated | The date and time that the agency updated the list last |
| last_imported | The date and teim that list was imported into the API |
