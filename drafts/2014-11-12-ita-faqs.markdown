...
The International Trade Administration's list of frequency asked questions.  The FAQs are searchable by keyword, and filterable by industry, country, topic, and update date.  
...
Searches for specific controlled [industry names](industry-list.html).  Enter multiple terms by separating with a comma.
